    ...
    return (
        <div>
            <dialog id="media-library-modal" className="modal">
                <div className="w-11/12 max-w-5xl px-0 modal-box">
                    ...
                    <div className="panel-wrapper h-[500px] overflow-y-scroll px-8">
                        {activeTab === "1" ? (
                            ...
                            <div className="h-full mt-4 overflow-y-scroll tab-2">
                                <h1 className="pb-4 mb-4 font-bold">
                                    All Media
                                </h1>
                    ...
                    <div className="pr-6 modal-action">
                        <form
                            method="dialog"
